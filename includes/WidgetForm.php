...
namespace Modules\Honeycomb_with_filter\Includes;
...
class WidgetForm extends CWidgetForm {
	...
	public function addFields(): self {
		return $this
			...
			->addField(
				new CWidgetFieldPatternSelectItem('host_filter_items', _('Host filter item patterns'))
			)
			->addField(
				(new CWidgetFieldTextBox('host_filter_value', _('Hide host when value equals')))
					->setDefault('0')
			)
			->addField(
